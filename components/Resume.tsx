...
const achievements = [
  {
    title: 'Class Topper',
    detail: 'Most years, with the kind of consistency that stops being a coincidence.',
    tag: 'Academics',
  },
  {
    title: 'Spelling Bee',
    detail: 'Won the kind of competition where one wrong vowel ends everything.',
    tag: 'Academics',
  },
  {
    title: 'Debate Circuit',
    detail: 'Argued for a living, basically. Turns out it was good training.',
    tag: 'Public Speaking',
  },
  {
    title: 'Speech Competitions',
    detail: 'Stood in front of rooms full of people and made it look easy.',
    tag: 'Public Speaking',
  },
  {
    title: 'Kho Kho',
    detail: 'Participated. Showed up. Played the game.',
    tag: 'Sports',
  },
  {
    title: 'Long Jump',
    detail: 'Ran, jumped, landed. Did it on purpose, apparently.',
    tag: 'Sports',
  },
  {
    title: 'Relay Race',
    detail: 'Trusted with the baton, which says a lot.',
    tag: 'Sports',
  },
  {
    title: '100m Sprint',
    detail: 'Fast. Faster than the explanation she gives for being late.',
    tag: 'Sports',
  },
  {
    title: 'Mandal-Level Recognition',
    detail: 'Stood out among roughly 21,000 students. Twenty-one thousand.',
    tag: 'Milestone',
  },
  {
    title: 'Kota — Class 11',
    detail: 'Went through the Kota phase and came out the other side intact.',
    tag: 'Milestone',
  },
];
