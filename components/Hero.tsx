...
const roles = ['Scholar.', 'Competitor.', 'Athlete.', 'Friend.', 'Problem.'];
      ...
      <div className="container-shell grid md:grid-cols-2 gap-12 md:gap-20 items-center">
        ...
        >
          ...
          <p className="mt-6 font-body text-sm text-paper-300/70 max-w-sm">
            Website chhoti hai par time dekar boht pyar se banaya hai.. Toh care karo na karo 😒👻👻 Padhna toh padega!! 🤣
          </p>
        </motion.div>
