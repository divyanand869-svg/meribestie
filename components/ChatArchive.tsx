...
const screenshots = [
  { src: '/screenshots/chat-01.jpg', caption: 'Yeh yaad hai?? Bohot hasi aai thi' },
  { src: '/screenshots/chat-02.jpg', caption: 'Tumhari pehli kahnaii.. Kitna kahani banati ho yrr' },
  { src: '/screenshots/chat-03.jpg', caption: 'machhli machhla ki kahani suna rahi thiii lolll...' },
  { src: '/screenshots/chat-04.jpg', caption: 'Hayye!! Sharama gaya dekhkar yeh yrr' },
  { src: '/screenshots/chat-05.jpg', caption: 'Isme bhi sharma gaya mai.. Loll par bohot maja aaya tha' },
  { src: '/screenshots/chat-06.jpg', caption: 'Yeh kaise bhulu?? Jao apne math ke master ke pas jao paraye mard ki tareef mere samne..!! pagal..' },
];
