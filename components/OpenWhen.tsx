...
const envelopes = [
  ...
  },
  {
    ...
    message:
      'Oii merse gussa hai?? Marunga abhi bohot jor se smjhi na?? Pagal... Terko permission kisne di merse gussa hone ki',
  },
  {
    title: 'Open When Missing Me',
    message:
      'miss kar rhi to text kar na!! Mar thodi gaya hun kahin... 🙂_(kahi mere marne ke baad senty hokr toh nahi dekh rhi yeh webpage?? Fir toh ro le banta hai rona tumhara)',
  },
  {
