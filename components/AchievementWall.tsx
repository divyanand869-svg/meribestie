...
const exhibits = [
  { title: 'Topper, Most Years', plate: 'On loan from the school records office' },
  { title: 'Mandal-Level Honor', plate: 'Among approx. 21,000 students' },
  { title: 'Kota, Survived', plate: 'Class 11, on display as proof of endurance' },
  { title: 'Debate & Speech Wins', plate: 'Multiple instances, rarely mentioned' },
];
